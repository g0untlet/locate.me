...
# ==========================================================================
# locate.me - Website Deployment to PROD Server
# Deploys ./website to a dedicated folder next to the PROD frontend so the
# app (frontend/backend/data) is never touched.
#
# PROD serving model (see docs/deploy-website-note.md):
#   - Content is physically hosted at https://locateme.srv64.de/website/
#     (the /website/ subpath of the PROD app domain).
#   - locate-me.net is a DNS alias (A + CNAME) to this server; Caddy serves
#     the same folder at the root of locate-me.net.
# ==========================================================================
...
REMOTE_APP_DIR="/home/gauntlet/homelab/locate.me"
REMOTE_TARGET_DIR="$REMOTE_APP_DIR/website/"

SAFETY_DIR_NAME="website"

echo "===================================================="
echo "🌐 Starting Website Deployment -> PROD Server"
echo "===================================================="
...
echo "===================================================="
echo "✔ Website successfully deployed to PROD!"
echo "===================================================="
