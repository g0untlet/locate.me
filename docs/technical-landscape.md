...
| `aroundme.max-places` | Maximum number of places returned for "Places around me" (default 10); `geoapify.limit` still controls the Geoapify fetch / cache size |
